...
let expensesTotal = document.querySelector("aside header h2")
let expensesQuantity = document.querySelector("aside header p span")
...
function expenseAdd(newExpense) {
  try {
    ...
    // Limpa o formulário para adicionar novo valor.
    formClear()
...
// Evento que captura clique nos itens da lista (li).
